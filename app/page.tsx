...
export default function Home(){
 ...
 async function openInspection(b:AdminBooking){
  ...
  if(r.error)setError(r.error.message);else{
   ...
   setInspection(d||null);setDirtLevel(d?.dirt_level||"MEDIUM");setBelongingsNotes(d?.belongings_notes||"");setDamageNotes(d?.preexisting_damage_notes||"");setInspectionBooking(b);
  }
  setBusy(false);
 }
