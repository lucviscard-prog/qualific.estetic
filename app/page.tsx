...
export default function Home(){ 
  ...
  return <main>
    <section className="hero"><div className="container">
      <nav className="nav"><div className="brand"><img src="/logo-qualificar.jpg" alt="Qualificar Estética Automotiva" /></div><div><a href="#servicos">Serviços</a><a href="#cuidado">Cuidado</a><a href="#acesso">Acessar</a></div></nav>
